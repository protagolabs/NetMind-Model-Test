...
def setup_args():
    ...
    parser.add_argument('--model_name_or_path', default= 'albert-base-v2' , type=str, required=False, help='')
    parser.add_argument('--per_device_train_batch_size', default= 8 , type=int, required=False, help='')
    parser.add_argument('--learning_rate', default= 1e-4 , type=float, required=False, help='')
    parser.add_argument('--num_train_epochs', default= 30 , type=int, required=False, help='')
