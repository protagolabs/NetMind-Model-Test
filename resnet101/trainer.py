...
def train(train_loader, train_sampler, val_loader, model, criterion, optimizer, args, device):
    ...
    print(f'model: {args.model_name_or_path} , batch_size: {args.per_device_train_batch_size}')
    print(f'len of dataloader : {len(train_loader)}')
    ...
    for epoch in range(epoch, args.num_train_epochs):
        ...
        for i, (images, target) in enumerate(train_loader):
            ...
            step += 1
        print(f'epoch : {epoch} end, step now: {step}')
    ...
    print(f'program finish, epoch:{epoch} step now: {step} ')
